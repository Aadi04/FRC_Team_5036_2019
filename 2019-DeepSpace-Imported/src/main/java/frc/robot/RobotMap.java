...
public class RobotMap {
  ...
  //Intake Pistons 
  public static final int LEFT_PISTON_IN = 5; // It was 4
  public static final int LEFT_PISTON_OUT = 1; // It was 0 
  //Hatch Pistons
  public static final int PUNCHER_IN = 6; 
  public static final int PUNCHER_OUT = 2;
  public static final int SLIDER_IN = 4; // It was 5
  public static final int SLIDER_OUT= 0;// It was 1
